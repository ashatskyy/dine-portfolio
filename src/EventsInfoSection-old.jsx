      ...
      <div className="events-picture-container">
        <picture>
          <source
            ...
            srcSet="
                          ./images/family-gathering-mobile.jpg 1x,
                          ./images/family-gathering-mobile@2x.jpg 2x"
          />
          <source
            media="(max-width: 1024px)"
            srcSet="
                          ./images/family-gathering-tablet.jpg 1x,
                          ./images/family-gathering-tablet@2x.jpg 2x"
          />
          <source
            media="(min-width: 1025px)"
            srcSet="
                          ./images/family-gathering-desktop.jpg 1x,
                          ./images/family-gathering-desktop@2x.jpg 2x"
          />
          <img
      ...
      <div className="events-picture-container">
        <picture>
          <source
            media="(max-width: 480px)"
            srcSet="
                          ./images/special-events-mobile.jpg "
          />
          <source
            media="(max-width: 1024px)"
            srcSet="
                          ./images/special-events-tablet.jpg"
          />
          <source
            media="(min-width: 1025px)"
            srcSet="
      ...
      <div className="events-picture-container">
       <picture>
          <source
            media="(max-width: 480px)"
            srcSet="
                          ./images/social-events-mobile.jpg "
          />
          <source
            media="(max-width: 1024px)"
            srcSet="
                          ./images/social-events-tablet.jpg"
          />
          <source
            media="(min-width: 1025px)"
            srcSet="
...
function Navigation({ setActiveSection, activeSection }) {
  return (
    <nav className="home-page-section-navigation">
      <div
